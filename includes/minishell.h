...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/07 14:40:26 by pbranco-          #+#    #+#             */
/*   Updated: 2025/04/14 08:09:01 by pbranco-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERROR_CDN "minishell: cd: %s: No such file or directory\n"
...
# define ERROR_ECHO "minishell: syntax error near unexpected token `newline'\n"
# define ERROR_SNTAX "minishell: syntax error near unexpected token `%s'\n"
...
void	export_existing_v(char *input, t_ms **ms, size_t i, size_t j);
...
char	*remove_quotes_execute(char *command, t_ms **ms);
