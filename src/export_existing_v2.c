...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   export_existing_v2.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hfilipe- <hfilipe-@student.42porto.com>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/31 10:44:19 by hfilipe-          #+#    #+#             */
/*   Updated: 2025/04/06 11:38:19 by hfilipe-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_new_var_name(char *var_name, t_ms **ms)
{
	...
	if (check_var_content(var_name, ms, 0, 0))
		return ((*ms)->exit_status = 1, free(var_name), NULL);
	if (found)
